...
export default class MultiSwitch extends Component {
  ...
  componentDidMount() {
    switch (this.props.initialButtonSelectedValue) {
      case this.props.firstButton.value:
        this.firstSelected()
        break
      case this.props.secondButton.value:
        this.secondSelected()
        break
      case this.props.thirdButton.value:
        this.thirdSelected()
        break
    }
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        >
          <Button
            label={this.props.getActiveButtonLabel(this.getButton()) || this.getButton().label}
            type={this.getStatus()}
            active={true}
...
MultiSwitch.propTypes = {
  initialButtonSelectedValue: PropTypes.string,
  disableScroll: PropTypes.func,
  onStatusChanged: PropTypes.func.isRequired,
  activeColor: PropTypes.string,
  getActiveButtonLabel: PropTypes.func.isRequired,

...
export default class MultiSwitch extends Component {
  ...
  notStartedSelected = () => {
    ...
    if (this.state.isComponentReady) this.props.onStatusChanged('1')
  }
  ...
  inProgressSelected = () => {
    ...
    if (this.state.isComponentReady) this.props.onStatusChanged('10')
  }
  ...
  completeSelected = () => {
    ...
    if (this.state.isComponentReady) this.props.onStatusChanged('100')
  }
  ...
  render() {
    return (
      <View style={styles.container}>
        <Button label="$1" type="1" onPress={this.notStartedSelected} />
        <Button label="$10" type="10" onPress={this.inProgressSelected} />
        <Button label="$100" type="100" onPress={this.completeSelected} />
        <Animated.View
        ...
        >
          <Button label={'$' + this.getStatus()} type={this.getStatus()} active={true} />
        </Animated.View>
      </View>
    )
  }
